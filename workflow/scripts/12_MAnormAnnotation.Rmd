...
if (params$PeakIdnt=='UNIQUE'){
  x1=ggplot(Peaksdata2_anno,
            aes(x=Counts_Unique,y=Length,color=`Both Strand: RNA_type_Classification`,
  ...
  x1=ggplot(Peaksdata2_anno,aes(x=Counts_Multimappers_Scaled,
...
x2=ggplot(Peaksdata2_anno,
          aes(x=Length))+geom_histogram(bins = 100)+
...
if (params$PeakIdnt=='UNIQUE'){
  x5=ggplot(Peaksdata2_anno,
            aes(x=Counts_Unique,line=`Both Strand: RNA_type_Classification`,
...
if (nrow(p)>0) {
  ...
  nccount$Counts_Unique=NA
  nccount$Counts_MM=NA;nccount$Peak_count=NA
