...
params:
  ...
  output_file: "/Users/homanpj/OneDrive - National Institutes of Health/Loaner/Wolin/CLIP/iCLIP_Git/workflow/scripts/AnnoTestPIPE/15_peaks/"
  ntmerge: "50nt"
  readdepth: 5
  species: 'hg38'
  Condense: FALSE
...
if (nrow(p)>0) {
  ...
  gg=ggplot(p,aes(x=RNA_Type,y=Counts_fracMM,fill=RNA_Type) ) +
    ...
    scale_y_continuous(trans = "log2") +
    ggtitle('Peak Counts (Unique + Frac. MM) for Ro-Clip\nby ncRNA Type')+ylab("Counts - Ro-Clip") +
    xlab("") +
