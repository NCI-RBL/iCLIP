...
params:
  ...
  output_file: "/Users/homanpj/OneDrive - National Institutes of Health/Loaner/Wolin/CLIP/CLIPpipeline/14_annotation/Control_Clip_50nt_peakannotation_finalPH.txt"
  ntmerge: "50nt"
  readdepth: 5
  species: 'hg38'
  Condense: FALSE
...
write.table(Peaksdata3_anno, file=output_file, sep = "\t", row.names = FALSE, col.names = T, append = F, quote= FALSE,na = "")
```
