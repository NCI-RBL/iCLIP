...
```{r, echo=FALSE, comment='', results="asis"}
process_score(paste0(output_dir,samplename,".old.txt"),
              paste0(output_dir,samplename,".old.png"))
```

#### Corrected MAPQ Scores
```{r, echo=FALSE, comment='', results="asis"}
process_score(paste0(output_dir,samplename,".new.txt"),
              paste0(output_dir,samplename,".new.png"))
```
