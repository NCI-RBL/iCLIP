...
input_phred = "/data/RBL_NCI/Phil/Reference/Index/novoalign/hg38/hg38_gencode_v32/MakeTranscriptome_genome/splitphred_"+transType
input_fasta = "/data/RBL_NCI/Phil/Reference/Index/novoalign/hg38/hg38_gencode_v32/MakeTranscriptome_genome/genome"
out_dir = "/data/data/RBL_NCI/Phil/Reference/Index/novoalign/hg38/hg38_gencode_v32/MakeTranscriptome_genome/MakeTranscriptome_"+transType+"_"+rad+"R"
...
script_name = "hg38_scriptloop_MakeTransctome_"+transType+"_"+rad+"R.sh"
...
for file in glob.glob(match_pattern):
    ...
    script += "-u "+input_phred+"/gencode.v32.chr_patch_hapl_scaff.annotation.gtf.SplicedTransc."+fname_toks[0]+".phred2 \\\n"
    script += "-r "+rad+" -s \n"
    script += "\n"
    script += "\n"
