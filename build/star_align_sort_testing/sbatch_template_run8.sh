...
--seedNoneLociPerWindow 20 --seedPerReadNmax 10000 --seedPerWindowNmax 500 --sjdbScore 2 --winAnchorMultimapNmax 500 --outBAMsortingBinsN 600 --limitBAMsortRAM 41143265264
