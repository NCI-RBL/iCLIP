...
--alignEndsType Local --alignIntronMax 50000 \
...
--seedNoneLociPerWindow 20 --seedPerReadNmax 10000 --seedPerWindowNmax 500 --sjdbScore 2 --winAnchorMultimapNmax 500

# Sort and Index
cp $tmp_dir/* $output_dir/$run_id/tmp
samtools sort --threads 32 -m 10G -T $tmp_dir $tmp_dir/${sample_id}_Aligned.out.bam -o $tmp_dir/${sample_id}_Aligned.sortedByCoord.out.bam
