...
if [ "$option" == "splits" ]; then \
    ...
    split --additional-suffix .fastq -l 1906896 --numeric-suffixes=1 --filter='gzip > $FILE.gz' - /data/RBL_NCI/Wolin/Sam/novoalign/splits/Ro_Clip_2.split.
fi
...
##############################################################################################################################
#Run cleanup
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/aligned"
...
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/cleanup"
...
##############################################################################################################################
#Run merged splits
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/unique_mm"
...
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/merge_splits"
...
##############################################################################################################################
#Run dedup
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/merged"
...
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/dedup"
...
# ##############################################################################################################################
#Run counts
input_dir_dedup="/data/RBL_NCI/Wolin/Sam/novoalign/dedup"
input_dir_saf="/data/RBL_NCI/Wolin/Sam/novoalign/saf"
...
output_dir="/data/RBL_NCI/Wolin/Sam/novoalign/annotations"
if [[ ! -d "$output_dir" ]]; then mkdir $output_dir; fi
...
input_dir="/data/RBL_NCI/Wolin/Sam/novoalign/counts"
